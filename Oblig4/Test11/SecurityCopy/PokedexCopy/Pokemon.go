...
func (f*Poke) getResp() {
	...
	if id < 152 && id > 0 {
		...
		resp = "Dette er et ugyldig navnet eller ID-nummer. Vær så snill å start porgrammet på nytt og skrev inn et gyldig navn eller IDnummer. Alt mellom 1-802 er en gyldig ID "
	}
}