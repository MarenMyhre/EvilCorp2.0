...
func IterateOverASCIIStringLiteral(sl string) {
	...
	// For øyeblikket vises ikke tegnene mellom byte  0x80 til 0x95. Det er fordi våre PCer ikke har tilgang på disse
	// tegnene. Dette kan fikses med å implementere runer inn i koden, men det har ikke vi gjort
}
